...
\nttitle(main,en){Compliance and Efficiency in Risk\\Assessment Tools for IT Infrastructure:\\ A NIS2-Aligned Comparative Analysis}%
...
%-------------------------------------------------------------------
\ntauthorname(m){António Ruben Cosinha Marinho}{António Marinho}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,m){\\António Luís Duarte Costa, Full Professor, NOVA University Lisbon}
% Co-advisers(s)
